...
export default function WithDriverPage() {
        ...
        .insert([
          {
            ...
            drop_location: `${tripType} | Destination: ${dropLocation || 'City Tour'}`,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 text-white rounded-3xl p-8 sm:p-12 space-y-4">
        ...
        <p className="text-slate-300 max-w-2xl text-sm sm:text-base leading-relaxed">
          Sit back and relax with our verified professional drivers. Transparent packages for local Mumbai trips, outstation getaways, and airport transfers.
        </p>

        {/* Feature Points */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-slate-800 text-xs">
          <div className="text-slate-300">✓ <strong>Verified</strong> Chauffeurs</div>
          <div className="text-slate-300">✓ <strong>₹500/day</strong> Driver Allowance</div>
          <div className="text-slate-300">✓ <strong>Clean</strong> AC Vehicles</div>
          <div className="text-slate-300">✓ <strong>Zero</strong> Advance Required</div>
        </div>
      </div>

      {/* Fleet Cards */}
      <div>
        <h2 className="text-2xl font-black text-slate-900 mb-6">Select Your Vehicle Segment</h2>

        {loading ? (
          <div className="text-center py-16 text-slate-500 font-semibold">Loading fleet options...</div>
        ) : cars.length === 0 ? (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2 text-xs font-semibold text-slate-600">
                      ...
                      <span className="bg-slate-100 px-2.5 py-1 rounded-lg">{car.luggage_capacity || 'Luggage Space'}</span>
                      <span className="bg-slate-100 px-2.5 py-1 rounded-lg">AC Cab</span>
                    </div>
                    ...
                    <div className="pt-3 border-t border-slate-100 space-y-2 text-xs">
                      ...
                      <div className="text-[11px] text-emerald-700 font-medium">
                        • Driver Allowance: ₹{car.driver_allowance}/day (where applicable)
                      </div>
                      <div className="text-[11px] text-slate-400">
                        • Toll, parking & state permits on actuals
                      </div>
                    </div>
                  </div>
      ...
      {selectedCar && (
        <div id="with-driver-request-form" className="bg-white border-2 border-emerald-600/30 rounded-3xl p-6 sm:p-10 shadow-lg space-y-8">
          ...
          <div>
            <span className="text-xs font-bold text-emerald-600 uppercase tracking-wider">Step 2: Trip Information</span>
            <h2 className="text-2xl font-black text-slate-900 mt-1">
              Booking Request: {selectedCar.car_segment_name}
            </h2>
            <p className="text-xs text-slate-500 mt-1">
              Submit your itinerary details. We will manually verify vehicle availability and call you to confirm your final quote.
            </p>
          </div>
          ...
          {bookingSuccessRef ? (
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-8 text-center space-y-4">
              ...
              <p className="text-xs text-slate-500 max-w-md mx-auto">
                Our operations team will check chauffeur availability and call you on your phone number shortly with complete details.
              </p>
              <div className="pt-4">
                <button
                  onClick={() => {
            ...
            <form onSubmit={handleSubmitBooking} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. Andheri East, Mumbai / Vashi, Navi Mumbai"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. Pune / Lonavala / Mumbai Airport / Local Sightseeing"
                    value={dropLocation}
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-xs text-slate-500">
                  ℹ️ Zero advance payment needed. We will call you to confirm driver allocation and final quote.
                </p>
                <button
                  type="submit"
