        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="text-xs text-emerald-400 font-medium">
              ✓ Verified Drivers • ✓ Zero Hidden Charges
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/with-driver" className="hover:text-white transition-colors">
                  Chauffeur Driven Outstation
                </Link>
              </li>
              <li>
                <Link href="/with-driver" className="hover:text-white transition-colors">
                  Local 8Hr / 80KM Rental
                </Link>
              </li>
              <li>
                <Link href="/with-driver" className="hover:text-white transition-colors">
              ...
              <li>
                <Link href="/self-drive" className="hover:text-white transition-colors">
                  Self Drive Hatchbacks & SUVs
                </Link>
              </li>
              <li>
                <Link href="/self-drive" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="hover:text-white transition-colors">Delhi to Agra / Jaipur</li>
              <li className="hover:text-white transition-colors">Mumbai to Pune / Lonavala</li>
              <li className="hover:text-white transition-colors">Bangalore to Mysore / Coorg</li>
              <li className="hover:text-white transition-colors">Chandigarh to Manali / Shimla</li>
              <li className="hover:text-white transition-colors">Ahmedabad to Udaipur / Statue of Unity</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+917303123786" className="text-white hover:underline font-medium">
                  +91 73031 23786
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <span className="text-emerald-500 font-bold">WhatsApp:</span>
                <a href="https://wa.me/917303123786" className="text-white hover:underline font-medium">
                  Instant Chat
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <span className="text-emerald-500 font-bold">Location:</span>
                <span>Serving 150+ Cities Pan India</span>
              </li>
            </ul>
          </div>
